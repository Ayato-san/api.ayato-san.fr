...
module.exports = function (req, res, next) {
    ...
    infoLog(`Request for ${req.protocol}://${req.headers.host}${req.originalUrl} by ${req.headers.referer || req.protocol + '://' + req.headers.host}`)

    // authorization checking (need to be modified for uses)
    if (req.method !== 'GET' && req.headers.authorization !== process.env.AUTH) {
